...
label = Label(root, fg='white', bg='black', font='Ariral 15 bold', text='Введите текст на Русском')
...
label = Label(root, fg='white', bg='black', font='Ariral 14 bold', text='Для перевода на Английский')
label.place(relx=0.5, y=5, anchor=CENTER)
